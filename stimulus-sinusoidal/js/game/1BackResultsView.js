...
(function (scope) {
    ...
    function OneBackResultsView(options) {
        this.initialize(options);
    }


    OneBackResultsView.prototype = new createjs.Container(); //inherits from container
    OneBackResultsView.prototype.Container_initialize = OneBackResultsView.prototype.initialize;

    var p = OneBackResultsView.prototype;
...
//        //update timer
//        var d = new Date();
//        var currentResponseDuration = d.getTime();
//        var totalTime = parseFloat(GLOBAL.GameInfo.oneBackDuration);
//
//        var proportion = (currentResponseDuration - this.startTime) / (totalTime * 1000);
////        console.log(proportion, currentResponseDuration, this.startTime,totalTime);
//        //this.timerIndicator.width = parseFloat(GLOBAL.GameInfo.timerWidth) * proportion;
//        //this.timerIndicator.shape.width = this.timerIndicator.w;
//        //this.timerIndicator.x = GLOBAL.GameInfo.width / 2 - parseFloat(GLOBAL.GameInfo.timerWidth)/2 + this.timerIndicator.w/2;
    ...
    scope.OneBackResultsView = OneBackResultsView;
