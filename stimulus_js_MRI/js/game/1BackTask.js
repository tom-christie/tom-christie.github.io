    ...
    OneBackTask.prototype = {
        ...
        initialize: function () {
            ...
            this.options = {
                ...
                instructions: "Press 1 or 2 to start the game.",
                newInstructions: "Press 1 if the arrow is the same as the previous arrow.\nPress 2 if it is different.",
                resultsInstructions: "Way to go.\n\nPress 1 or 2 to begin the next round.",
        ...
        initTrial: function () {
            ...
            var markovSameProbs = [.75,.75,.75,.75];//[.9, .75, .25, .1];
