    ...
    Intro.prototype = {
        ...
        initialize: function () {
            ...
            this.options = {
                ...
                oneback: {
                    instructions:"Press any key to move the first arrow. After the first arrow, press 1 if the arrow is the same as the previous arrow, or 2 if it is different."
                }
            };
