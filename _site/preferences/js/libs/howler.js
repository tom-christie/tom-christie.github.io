...
////////////////////////////////////////////////////////////////
// One minor tweak for better performance on win8/winRT/wp8
// made by McFunkypants: (see line 250)
////////////////////////////////////////////////////////////////
...
(function() {
  ...
  Howl.prototype = {
    ...
    load: function() {
      ...
      if (self._webAudio) {
        ...
        if (!self._loop) {
            ...
            newNode.msAudioCategory = "GameMedia";
        }
        ////////////////////////////////////////////////////////////////
    ...
    play: function(sprite, callback) {
	  ...
	  //if (window.external) // FIXME && window.external.Notify) // ERRORS OUT
	  //{
	  // $CTK workaround for broken html5 sound in wp8 windows phone 8
		...
		window.external.Notify('wp8 sound engine request:'+sprite);

		// only works for a single digit
		if (sprite == 'spawn') wp8SoundIndex = 1;
		if (sprite == 'shootArrow') wp8SoundIndex = 2;
		if (sprite == 'shootFire') wp8SoundIndex = 3;
		if (sprite == 'shootEnergy') wp8SoundIndex = 4; // unused
		if (sprite == 'hitEnergy') wp8SoundIndex = 4;
		if (sprite == 'openBuildMenu') wp8SoundIndex = 5;
		if (sprite == 'Build') wp8SoundIndex = 6;
		if (sprite == 'Goal') wp8SoundIndex = 7;
		if (sprite == 'Victory') wp8SoundIndex = 8;
		if (sprite == 'Defeat') wp8SoundIndex = 8;
		if (sprite == 'NotEnoughMoney') wp8SoundIndex = 9;
		if (sprite == 'intro') wp8SoundIndex = 10;
		if (sprite == 'music') wp8SoundIndex = 0;
		if (sprite == 'menuclick') wp8SoundIndex = 5;
		if (sprite == 'mapclick') wp8SoundIndex = 7;

		if (wp8SoundIndex >= 0) 
		{
			// send a message to C# which will play a sound using the low level C++ sound engine
			window.external.Notify('SFX:'+wp8SoundIndex);
		}
		return;
	  }
